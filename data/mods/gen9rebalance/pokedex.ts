export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	garchomp: {
		...
		name: "Garchomp",
		types: ["Dragon", "Ground"],
		baseStats: {hp: 108, atk: 135, def: 95, spa: 75, spd: 85, spe: 102},
		abilities: {0: "Sand Veil", H: "Sand Rush"},
		heightm: 1.9,
		weightkg: 95,
		color: "Blue",
	...
	ursalunabloodmoon: {
		...
		types: ["Ground", "Normal"],
		gender: "M",
		baseStats: {hp: 113, atk: 120, def: 80, spa: 125, spd: 45, spe: 52},
	...
	espathra: {
		...
		name: "Espathra",
		types: ["Psychic"],
		baseStats: {hp: 95, atk: 60, def: 60, spa: 101, spd: 60, spe: 99},
		abilities: {0: "Opportunist", 1: "Frisk", H: "Adaptability"},
		heightm: 1.9,
		weightkg: 90,
		color: "Yellow",
		prevo: "Flittle",
	...
	ironbundle: {
		...
		types: ["Ice", "Water"],
		gender: "N",
		baseStats: {hp: 56, atk: 70, def: 84, spa: 104, spd: 70, spe: 116},
		abilities: {0: "Quark Drive"},
		heightm: 0.6,
		weightkg: 11,
		color: "Red",

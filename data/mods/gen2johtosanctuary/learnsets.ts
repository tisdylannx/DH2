export const Learnsets: {[k: string]: ModdedLearnsetData} = {
	...
	sceptile: {
		learnset: {
			...
			hiddenpower: ["2L1"],
			hiddenpowerfire: ["2L1"],
			hiddenpowerwater: ["2L1"],
			hiddenpowerelectric: ["2L1"],
			hiddenpowergrass: ["2L1"],
			hiddenpowerice: ["2L1"],
			hiddenpowerfighting: ["2L1"],
			hiddenpowerpoison: ["2L1"],
			hiddenpowerground: ["2L1"],
			hiddenpowerflying: ["2L1"],
			hiddenpowerpsychic: ["2L1"],
			hiddenpowerbug: ["2L1"],
			hiddenpowerrock: ["2L1"],
			hiddenpowerghost: ["2L1"],
			hiddenpowerdragon: ["2L1"],
			hiddenpowerdark: ["2L1"],
			hiddenpowersteel: ["2L1"],
			hyperbeam: ["2L1"],
			irontail: ["2L1"],
			leer: ["2L1"],
			lowkick: ["2L1"],
